...
SELECT fil_cd_filme, fil_tl_original, fil_cd_diretor, fil_cd_duracao, gen_dc_genero
FROM FIL_filme, GEN_genero, PAI_pais
WHERE fil_tl_original LIKE 'B%' AND fil_tl_portugues IS NULL AND gen_cd_genero = 2 AND pai_cd_pais = 1;