...
SELECT cin_nm_fantasia AS nome, cin_cp_lotacao AS capacidade, cin_cp_lotacao * 2 AS dobro FROM CIN_cinema WHERE cin_cd_cidade = 1 ORDER BY cin_nm_fantasia ASC;